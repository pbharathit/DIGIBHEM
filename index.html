...
class Numbergame2 extends JFrame
{
 ...
 JLabel z=new JLabel("2.EACH PLAYER HAS ONLY 10 CHANCES");
 JLabel w=new JLabel("3.SCORING PATTERN");
 JLabel x1=new JLabel("a.guessed between 1 to 3 chances-->1000");
 JLabel x2=new JLabel("b.Guessed between 4 to 6 chances-->900");
 JLabel x3=new JLabel("c.Guessed between 7 to 10 chances-->800");
...
l1.setBounds(200,10,500,40);
 ...
 JTextField tf1=new JTextField();
  ...
  f.add(b3);
  f.add(tf1);
 JLabel l4=new JLabel("You Have Only 10 Chances");
